...
vtbackup Pods spawned for this tablet pool&rsquo;s shard, so this field
can be used to customize settings like innodb_redo_log_capacity
for backup jobs, without needing separate vtbackup-specific config.</p>
</td>
</tr>
</tbody>
</table>
...
<td>
<em>(Optional)</em>
<p>Tolerations allow you to schedule backup pods onto nodes with matching taints.
If omitted, the controller uses the default tolerations for the selected backup method.
To explicitly clear inherited tolerations, set this field to an empty list.</p>
</td>
</tr>
</tbody>
</table>
...
<code>vtbackup</code><br>
<em>
<a href="#planetscale.com/v2.VitessShardVtbackup">
VitessShardVtbackup
</a>
</em>
</td>
<td>
<p>Vtbackup configures the scratch data volume for vtbackup Pods in this
shard. When omitted, initial and scheduled vtbackup Pods inherit the first
tablet pool&rsquo;s DataVolumeClaimTemplate.</p>
</td>
</tr>
<tr>
<td>
...
<h3 id="planetscale.com/v2.VitessShardVtbackup">VitessShardVtbackup
</h3>
<p>
(<em>Appears on:</em>
<a href="#planetscale.com/v2.VitessShardTemplate">VitessShardTemplate</a>)
...
<p>
<p>VitessShardVtbackup configures scratch storage for vtbackup Pods in a shard.</p>
</p>
<table class="table table-striped">
<thead class="thead-dark">
<tr>
...
<tr>
<td>
<code>useEmptyDirForInitialBackup</code><br>
<em>
bool
</em>
</td>
<td>
<p>UseEmptyDirForInitialBackup makes the initial, empty-database backup use
ephemeral scratch space instead of inheriting the first tablet pool&rsquo;s
DataVolumeClaimTemplate. Scheduled backups still inherit the first tablet
pool&rsquo;s template because they restore a full database before taking a backup.</p>
</td>
</tr>
<tr>
<td>
