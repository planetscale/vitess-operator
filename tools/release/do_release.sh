...
echo "-----------------------"
echo ""
echo -e "\tPlease push the new git tag:"
echo ""
echo -e "\t\tgit push origin v$NEW_OPERATOR_VERSION"
echo ""
echo -e "\tAnd push your current branch in order to open a Pull Request against the release branch."
echo ""
echo ""