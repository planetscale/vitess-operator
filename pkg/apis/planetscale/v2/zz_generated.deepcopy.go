...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MysqlctldSpec) DeepCopyInto(out *MysqlctldSpec) {
	*out = *in
	in.Resources.DeepCopyInto(&out.Resources)
	if in.ExtraFlags != nil {
		in, out := &in.ExtraFlags, &out.ExtraFlags
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MysqlctldSpec.
func (in *MysqlctldSpec) DeepCopy() *MysqlctldSpec {
	if in == nil {
		return nil
	}
	out := new(MysqlctldSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VitessBackupScheduleStatus) DeepCopyInto(out *VitessBackupScheduleStatus) {
	*out = *in
	...
	if in.NextScheduledTimes != nil {
		in, out := &in.NextScheduledTimes, &out.NextScheduledTimes
		*out = make(map[string]*metav1.Time, len(*in))
		for key, val := range *in {
			(*out)[key] = val.DeepCopy()
		}
...
func (in *VitessCellGatewayStatus) DeepCopyInto(out *VitessCellGatewayStatus) {
	*out = *in
	if in.TabletRefreshInterval != nil {
		in, out := &in.TabletRefreshInterval, &out.TabletRefreshInterval
...
func (in *VitessShardTemplate) DeepCopyInto(out *VitessShardTemplate) {
	*out = *in
	...
	if in.Vtbackup != nil {
		in, out := &in.Vtbackup, &out.Vtbackup
		*out = new(VitessShardVtbackup)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VitessShardVtbackup) DeepCopyInto(out *VitessShardVtbackup) {
	*out = *in
	if in.DataVolumeClaimTemplate != nil {
		in, out := &in.DataVolumeClaimTemplate, &out.DataVolumeClaimTemplate
		*out = new(v1.PersistentVolumeClaimSpec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VitessShardVtbackup.
func (in *VitessShardVtbackup) DeepCopy() *VitessShardVtbackup {
	if in == nil {
		return nil
	}
	out := new(VitessShardVtbackup)
