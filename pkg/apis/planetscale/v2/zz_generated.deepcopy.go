...
func (in *VitessShardTabletPool) DeepCopyInto(out *VitessShardTabletPool) {
	*out = *in
	...
	if in.Vtbackup != nil {
		...
		*out = new(VitessShardTabletPoolVtbackup)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VitessShardTabletPoolVtbackup) DeepCopyInto(out *VitessShardTabletPoolVtbackup) {
	*out = *in
	if in.DataVolumeClaimTemplate != nil {
		in, out := &in.DataVolumeClaimTemplate, &out.DataVolumeClaimTemplate
		*out = new(v1.PersistentVolumeClaimSpec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VitessShardTabletPoolVtbackup.
func (in *VitessShardTabletPoolVtbackup) DeepCopy() *VitessShardTabletPoolVtbackup {
	if in == nil {
		return nil
	}
	out := new(VitessShardTabletPoolVtbackup)
