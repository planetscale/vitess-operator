...
// ServiceName returns the name of the orchestrator Service for a cluster.
func ServiceName(clusterName string) string {
	return names.Join(clusterName, planetscalev2.OrcComponentName)
}

// NewService creates a new Service object for orchestrator.
...
// UpdateService updates the mutable parts of the orchestrator Service.
